  ...
  return (
    <>
      ...
      <main className="join-page" lang="zh-CN">
        <section className="join-intro"><div className="join-intro-inner"><p className="eyebrow eyebrow-light">从这里开始成为会员</p><h1>您的下一个好习惯，<br />也许就是 <em>WLHL。</em></h1><p>请简单介绍自己。我们会帮助您找到志同道合的伙伴、适合的活动和舒服的健康节奏。</p><div className="join-perks"><span><Check size={16} /> 温暖友善、尊重每个年龄阶段</span><span><Check size={16} /> 适合不同节奏与经验的活动</span><span><Check size={16} /> 提交申请无需付款</span></div><div className="join-art" aria-hidden="true"><Leaf size={170} /><HeartHandshake size={80} /></div></div></section>
